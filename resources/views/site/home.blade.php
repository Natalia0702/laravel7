...
<head>
  ...
  <link src="stylesheet" href="http://localhost/laravel7/public/style.css">
</head>
...
<body>
    ...
    <div class="container">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="sparkline13-list">
          ...
          <form action="user" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" id="inputNome" name="name" placeholder="Nome" value="">
                </div>
              </div>
              <div class="form-group">
          ...
          <!--
              <button class="btn btn-primary" type=" " id="verificaUsuario" onclick="verificaUsuario()">Salvar Dados</button>
              <br><br><br>-->
        </div>
        <div id="novaSenha"></div>
      </div>
    </div>
  ...
  ================================================== -->
    ...
    <footer class="container">
      ...
      <p>© {{date('Y-M')}} Company, Inc. · <a href="#">Privacy</a> · <a href="#">Terms</a></p>
    </footer>
  </main>
